# Project A: Run tests script for vulnerable application
# This script runs the full test cycle for Project A
...
Write-Host "Project A: Pre-Mitigation Tests" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
...
Write-Host "Results: $ResultsDir\results_pre.json" -ForegroundColor Green
