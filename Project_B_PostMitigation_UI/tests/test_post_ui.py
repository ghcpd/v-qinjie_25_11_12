...
def run_tests(repeat=1, browser_name='chromium', override_viewport=None):
        ...
        for i in range(repeat):
            for case in cases:
                ...
                try:
                    ...
                    # Determine outcomes (Post-mitigation: expect NO xss and NO secret leaks)
    ...
    os.makedirs(os.path.join(ROOT, 'results'), exist_ok=True)
    with open(os.path.join(ROOT, 'results_post.json'), 'w', encoding='utf-8') as fh:
